...
__all__ = [ "BodyPoseWorker" ]

class BodyPoseWorker(Worker):
    """Detect person object with body pose information in the received frame from client"""
    DEFAULT_CONFIG = {
        "detection_model": "BodyPoseDetector",
    }
    ...
    def _detect_handler(self, request):
        ...
        for pid, people in zip(pids, results):
            video_results.append({ 'pid': pid, 'people': people })
