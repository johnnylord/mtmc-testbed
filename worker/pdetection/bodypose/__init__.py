...
class BodyDetector(PoseDetector):
    ...
    def postprocessing(self, imgs, heatmaps, pafs):
        ...
        for idx, (img, heatmap, paf) in enumerate(zip(imgs, heatmaps, pafs)):
        ...
        # TODO: The following sections is not analyzed well
        # ====================================================================
        candidates = []
        subsets = []
        ...
        for heatmap, paf in zip(heatmaps, pafs):
            ...
            # Append result to candiates & subsets
